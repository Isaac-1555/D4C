...
import type { AgentMessage, StreamFn, ThinkingLevel } from "d4c-agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "d4c-ai";
import { completeSimple } from "d4c-ai";
import {
	convertToLlm,
